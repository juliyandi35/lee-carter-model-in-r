...
TahunValuasi<-2024
# =================== Baca Data ===================
data_peserta <- read_excel("C:/Users/Nela Aidatun/Downloads/data pensiun.xlsx")
tmi_iv <- read_excel("C:/Users/Nela Aidatun/Downloads/TM IV.xlsx")
lc_laki <- read_excel("C:/Users/Nela Aidatun/Downloads/TM LC.xlsx", sheet = "Laki-laki",)
lc_perempuan <- read_excel("C:/Users/Nela Aidatun/Downloads/TM LC.xlsx", sheet = "Perempuan",)
...
saveWorkbook(wb, "C:/Users/Nela Aidatun/Downloads/hasil_Tahap1_Gaji_Benefit.xlsx", overwrite = TRUE)
...
saveWorkbook(wb1, "C:/Users/Nela Aidatun/Downloads/hasil_TMI_IV.xlsx", overwrite = TRUE)
...
saveWorkbook(wb2, "C:/Users/Nela Aidatun/Downloads/hasil_TMLC_P_Tahun2020-2046.xlsx", overwrite = TRUE)
...
saveWorkbook(wb3, "C:/Users/Nela Aidatun/Downloads/hasil_TMLC_L_Tahun2020-2046.xlsx", overwrite = TRUE)
...
saveWorkbook(wb_pvfb_semua, "C:/Users/Nela Aidatun/Downloads/hasil_PVFB_Tahunan_TMI_dan_TM_LC.xlsx", overwrite = TRUE)
...
hitung_NC_AL_EAN <- function(PVFB_df, hasil_lxDx, usia_sekarang, usia_pensiun, peserta_id = NULL) {
  ...
  AL[PVFB_df$t == 0] <- round(PVFB_df$PVFB[PVFB_df$t == 0], 2)
  AL[is.na(AL)] <- NA
...
for (i in 1:nrow(data_peserta)) {
  ...
  peserta_id <- data_peserta$ID[i]  # Tambahkan ini
  usia_pensiun <- 55
...
saveWorkbook(wb_ean, "C:/Users/Nela Aidatun/Downloads/hasil_EAN_NC_AL_TMI_TM_LC.xlsx", overwrite = TRUE)
...
# Simpan workbook
saveWorkbook(wb_delta, "C:/Users/Nela Aidatun/Downloads/hasil_FIL_DeltaBt_PVFBtilde.xlsx", overwrite = TRUE)
...
saveWorkbook(wb, "C:/Users/Nela Aidatun/Downloads/FIL_FIX_NC_Konstan.xlsx", overwrite = TRUE)
