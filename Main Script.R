setwd("D:/Kerjaan/Research Consultant/Project Lee Carter Model in R")
# Gunakan Working Directory yang di bawah, hapus alamat yang di atas, dan hapus tanda "#" di bawah
